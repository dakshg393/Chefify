...
def recipe_detail(request, pk):
    ...
    if request.user.is_authenticated:
        ...
        return render(request, 'recipe_detail.html', {'recipe': recipe, 'recipe_detail': recipe_detail, 'recipe_steps': recipe_steps , 'ingredients_list': ingredients_list ,'rating_instance':})
